...
void Scanner::Init() {
	...
	for (i = 48; i <= 57; ++i) start.set(i, 28);
	start.set(46, 29);
	start.set(40, 15);
	start.set(41, 16);
	start.set(61, 50);
	...
	keywords.set(L"void", 8);
	keywords.set(L"if", 26);
...
Token* Scanner::NextToken() {
	...
	switch (state) {
		...
		case 2:
			...
			else if (ch == L'D' || ch == L'F' || ch == L'M' || ch == L'd' || ch == L'f' || ch == L'm') {AddCh(); goto case_14;}
		...
		case 17:
			case_17:
			if (ch == 9 || (ch >= 11 && ch <= 12) || ch == L' ') {AddCh(); goto case_17;}
			else if (ch == L'o') {AddCh(); goto case_18;}
			else {goto case_0;}
		case 18:
			case_18:
			if (ch == L'p') {AddCh(); goto case_19;}
			else {goto case_0;}
		case 19:
			case_19:
		...
		case 22:
			case_22:
			if (ch == L'i') {AddCh(); goto case_23;}
			else {goto case_0;}
		case 23:
			case_23:
			if (ch == L'z') {AddCh(); goto case_24;}
			else {goto case_0;}
		case 24:
			case_24:
		...
		case 25:
			case_25:
			if (ch == 10 || ch == 13) {AddCh(); goto case_27;}
			else if (ch <= 9 || (ch >= 11 && ch <= 12) || (ch >= 14 && ch <= L'n') || (ch >= L'p' && ch <= 65535)) {AddCh(); goto case_26;}
			else if (ch == L'o') {AddCh(); goto case_30;}
			else {goto case_0;}
		case 26:
			case_26:
			if (ch == 10 || ch == 13) {AddCh(); goto case_27;}
			else if (ch <= 9 || (ch >= 11 && ch <= 12) || (ch >= 14 && ch <= 65535)) {AddCh(); goto case_26;}
			else {goto case_0;}
		case 27:
			case_27:
			{t->kind = 28; break;}
		...
		case 30:
			case_30:
			if (ch == 10 || ch == 13) {AddCh(); goto case_27;}
			else if (ch <= 9 || (ch >= 11 && ch <= 12) || (ch >= 14 && ch <= L'e') || (ch >= L'g' && ch <= 65535)) {AddCh(); goto case_26;}
			else if (ch == L'f') {AddCh(); goto case_31;}
			else {goto case_0;}
		case 31:
			case_31:
			if (ch == 10 || ch == 13) {AddCh(); goto case_27;}
